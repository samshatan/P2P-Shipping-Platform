  ...
  return (
    <div className="max-w-md mx-auto py-12 px-4">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-black mb-3 text-text-main tracking-tight">Welcome back</h2>
        <p className="text-text-muted font-medium">Log in to see your shipping history and saved details.</p>
      </div>
      ...
      <div className="bg-bg-main p-8 rounded-[2rem] shadow-2xl shadow-brand-primary/5 border border-border-main glass">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2 text-left">
            <div className="flex justify-between items-center ml-1">
              <label className="text-xs font-black text-text-muted uppercase tracking-[0.2em]">Password</label>
              <a href="#" className="text-[10px] font-black text-brand-primary uppercase tracking-widest hover:underline">Forgot?</a>
            </div>
            <div className="relative group">
          ...
          >
            {isLoading ? <Loader2 className="w-6 h-6 animate-spin" /> : <>Log In <ArrowRight className="w-6 h-6" /></>}
          </button>
        </form>
        ...
        <div className="mt-8 relative">
          ...
          <div className="relative flex justify-center text-[10px] font-black uppercase tracking-[0.3em]">
            <span className="bg-bg-main px-4 text-text-muted">Or continue with</span>
          </div>
        </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-sm font-medium text-text-muted">
          ...
          <button onClick={onSwitch} className="text-brand-primary font-bold hover:underline">Create one for free</button>
        </p>
