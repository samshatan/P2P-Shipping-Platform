  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 pt-16">
        <div className="w-full max-w-md bg-card p-8 rounded-[2rem] border border-border shadow-sm text-center">
            ...
            <div className="flex justify-between gap-2 max-w-[280px] mx-auto">
              {otp.map((digit, i) => (
                <input
                  ...
                  autoFocus={i === 0}
                  className="w-10 h-12 bg-muted/50 border border-border rounded-xl flex items-center justify-center font-bold text-xl text-center focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all"
                />
              ))}
            </div>
              ...
              {isExpired ? (
                <div className="space-y-4 animate-in fade-in zoom-in duration-300">
                  ...
                  <Button 
                    ...
                    className="w-full h-12 bg-primary hover:bg-primary/90 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all active:scale-95 shadow-lg shadow-primary/20"
                  >
