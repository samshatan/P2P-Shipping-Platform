...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-col w-1/3 bg-background border-r border-border p-8 justify-between">
      ...
      <div className="flex-1 flex flex-col items-center p-6 justify-center bg-background">
        <div className="w-full max-w-md space-y-8 bg-card p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-border/60">
          ...
          {step === 1 && (
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                <button 
                  ...
                  style={{
                    ...
                    backgroundColor: role === "USER" ? "hsl(var(--primary) / 0.04)" : "hsl(var(--card))",
                    cursor: "pointer",
                    transition: "all 0.2s",
                    display: "flex",
                ...
                >
                  ...
                  <div>
                    <h3 style={{ fontSize: "16px", fontWeight: 600, color: "hsl(var(--foreground))", margin: 0 }}>Individual Sender</h3>
                ...
                <button 
                  ...
                  style={{
                    ...
                    backgroundColor: role === "BUSINESS" ? "hsl(var(--primary) / 0.04)" : "hsl(var(--card))",
                    cursor: "pointer",
                    transition: "all 0.2s",
                    display: "flex",
                    alignItems: "flex-start",
                ...
                >
                  ...
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <h3 style={{ fontSize: "16px", fontWeight: 600, color: "hsl(var(--foreground))", margin: 0 }}>Business / D2C Brand</h3>
                      <span style={{
              ...
              <Button onClick={() => setStep(2)} className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-semibold shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                 <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  <Label style={{ fontSize: "14px", fontWeight: 600, color: "hsl(var(--foreground))" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: "hsl(var(--foreground))" }}>Your Aadhaar KYC will be linked to this number for seamless verification later.</p>
                </div>
